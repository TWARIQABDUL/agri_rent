...
class AppColors {
  ...
  static const Color primaryLight = Color(0xFFE8F5E9); // Light green for selected chips
  static const Color accentYellow = Color(0xFFF5A623); // Yellow/Orange for Track button
